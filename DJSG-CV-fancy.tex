...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			responsiveness to climate forcing,'' \emph{Resubmitted} to Water Resources Research.}
		\lpdentry
			{\emph{in review}}
		...
		\lpdentry
			...
			{Land Surfaces at the Tipping-Point for Water and Energy Balance Coupling}
			{Water Resources Research}
			{Dong, J, R Akbar, \textcl{DJ Short Gianotti}, AF Feldman, WT Crow, \& D Entekhabi, ``Can Surface Soil
			 Moisture Information Identify the Landscape Evapotranspiration Transition Between Energy- and Water-limited 
			 Regimes?,'' \emph{In preparation} for Water Resources Research.}		
		\lpdentry
			{\emph{in prep}}
