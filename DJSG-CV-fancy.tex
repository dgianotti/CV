...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			limitation across global ecosystems,'' \emph{Submitted} to Remote Sensing of Environment.}		
		\lpdentry
			{\emph{submitted}}
			...
			responsiveness to climate forcing,'' \emph{Submitted} to Water Resources Research.}
		\lpdentry
			{\emph{submitted}}
			...
			assessment of meteorological and agricultural drought in Mainland Southeast Asia,'' \emph{Submitted} to 
			Journal of Selected Topics in Applied Earth Observations and Remote Sensing.}			
		\lpdentry
			{\emph{in prep}}
