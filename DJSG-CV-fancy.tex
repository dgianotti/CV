...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			{Feldman, AF, \textcl{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Land-atmosphere drivers of landscape-scale plant water content loss,'' \emph{In press} in Geophysical Research Letters.}
		\lpdentry
			{\emph{submitted}}
