...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			{Zhang, LN, \textcl{DJ Short Gianotti}, \& D Entekhabi, ``Land Surface Influence on Convective Available Potential Energy (CAPE)
			Change During Interstorms,'' \emph{submitted} to Journal of Hydrometeorology.}
	...
	\subsection{Published Journal Articles}
		\lpdentry
			...
			changes and the role of drylands,'' Global Change Biology. \url{https://doi.org/10.1111/gcb.16455} }
		\lpdentry
			{2022c}
