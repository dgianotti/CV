...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			satellite-era hydrological dynamics,'' \emph{In revision} in Water Resources Research.}
		\lpdentry
			{\emph{resubmitted}}
		...
		\lpdentry
			...
			{Feldman, AF, \textcl{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Land-				atmosphere drivers of landscape-scale plant water content loss,'' \emph{Submitted} to 					Geophysical Research Letters.}
