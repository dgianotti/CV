...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			{\emph{submitted}}
			{Microwave satellites capture soil moisture dynamics deeper than a few centimeters and are relevant to plant water uptake}
			{Nature Geoscience}
			{Feldman, AF, \textcl{DJ Short Gianotti}, J Dong, R Akbar, WT Crow, KA McColl, JB Nippert, NM Holbrook, 
			FE Rockwell, RL Scott, RH Reichle, A Chatterjee, J Joiner, B Poulter, D Entekhabi, ``Microwave 
			satellites capture soil moisture dynamics deeper than a few centimeters and are relevant to plant water 
			uptake,'' 
			\emph{Submitted} to Nature Geoscience.\\
			Preprint: \url{https://doi.org/10.1002/essoar.10511280.1}}			
		...
		\lpdentry
			...
			limitation across global ecosystems,'' \emph{In revision} at Biogeosciences.}		
		\lpdentry
			{\emph{in review}}
		...
		\lpdentry
			...
			the Tipping-Point for Water and Energy Balance Coupling,'' \emph{Re-submitted} at Water Resources Research.}		
		\lpdentry
			{\emph{in prep}}
