...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			{Feldman, AF, \textcl{DJ Short Gianotti}, J Dong, IF Trigo, GD Salvucci, D Entekhabi, ``Tropical surface temperature response to vegetation cover
			changes and the role of drylands,'' \emph{Resubmitted} to Global Change Biology.}
