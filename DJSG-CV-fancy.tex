...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			{\emph{submitted}}
			{Propagation from Meteorological Drought to Agricultural Drought Intensifies Under Climate Change}
			{Earth's Future}
			{Gannon, MJ, \textcl{DJ Short Gianotti}, \& D Entekhabi, ``Propagation from Meteorological Drought to Agricultural Drought Intensifies 
				Under Climate Change,'' \emph{Submitted} to Earth's Future.}					
