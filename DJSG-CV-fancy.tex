...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			...
			{Nature Geoscience}
			{\textcl{Short Gianotti, DJ}, KA McColl, X Xu, AF Feldman, \& D Entekhabi, ``Ecosystem 
			structural dynamics dominate physiology in coupling the terrestrial water and carbon cycles,'' 
			\emph{Submitted} to Nature.}
		\lpdentry
			{\emph{in review}}
			...
			limitation across global ecosystems,'' \emph{In review} at Remote Sensing of Environment.}		
		\lpdentry
			{\emph{accepted}}
			...
			responsiveness to climate forcing,'' \emph{In press} in Water Resources Research.}
		\lpdentry
			{\emph{in review}}
		...
		\lpdentry
			...
			{Water Resources Research}
			{Dong, J, R Akbar, AF Feldman, \textcl{DJ Short Gianotti}, \& D Entekhabi, ``Land Surfaces at the 
			Tipping-Point for Water and Energy Balance Coupling,'' \emph{Submitted} to Water Resources Research.}		
		\lpdentry
			{\emph{submitted}}
			{Can Surface Soil
			 Moisture Information Identify the Landscape Evapotranspiration Transition Between Energy- 
			 and Water-limited Regimes?}
			{Geophysical Research Letters}
			{Dong, J, R Akbar, \textcl{DJ Short Gianotti}, AF Feldman, WT Crow, \& D Entekhabi, 
			``Can Surface Soil Moisture Information Identify the Landscape Evapotranspiration 
			Transition Between Energy- and Water-limited Regimes?,'' \emph{Submitted} to Geophysical Research Letters.}		
		\lpdentry
			{\emph{in prep}}
...
\subsection{Conference \& Workshop Organization}
	\lpdentry
		...
		{American Geophysical Union Fall Meeting}
		{Primary Convener: \textcl{DJ Short Gianotti}, Conveners: Xiangtao Xu, Yanlan Liu, \& Vincent Humphrey}
