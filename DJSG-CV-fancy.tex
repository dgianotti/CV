...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			...
			{Jonard, F, S DeCanni\`ere, N Br\"uggemann, P Gentine, \textcl{DJ Short Gianotti}, G Lobet, DG Miralles, C Montzka, BR Pag\'an, 
			U Rascher, \& H Vereecken ''Value of chlorophyll fluorescence for quantifying hydrological states and fluxes: Current status and 
			challenges,'' \emph{In review} in Agricultural and Forest Meteorology.}
		\lpdentry
			{\emph{in revision}}
			...
			soil moisture pulses,'' In review in New Phytologist.}
		\lpdentry
			{\emph{submitted}}
			...
			satellite-era hydrological dynamics,'' \emph{Submitted} to Water Resources Research.}
		\lpdentry
			{\emph{submitted}}
			...
			mesic environments,'' \emph{Submitted} to Water Resources Research.}
		\lpdentry
			{\emph{in prep}}
			{A kernel\hyp{}auto\hyp{}regressive weather generator for improved 
			subseasonal\hyp{}to\hyp{}seasonal precipitation statistics}
			{Water Resources Research}
			{\textcl{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci, ``A kernel\hyp{}auto\hyp{}regressive weather generator for improved 
			subseasonal\hyp{}to\hyp{}seasonal precipitation statistics,'' Expected submission in Water Resources Research, April 2020.}
	...
	\subsection{Published Journal Articles}
		\lpdentry
			...
			{\textcl{Short Gianotti, DJ}, R Akbar, AF Feldman, GD Salvucci, \& D Enthekabi, ``Terrestrial evaporation and moisture drainage 
		...
		\lpdentry
			...
			{Water Resources Research}
			{Feldman, AF, \textcl{DJ Short Gianotti}, I Trigo, GD Salvucci, \& D Entekhabi, ``Satellite-based assessment of land surface 
