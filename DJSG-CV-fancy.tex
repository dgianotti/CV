...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			{\emph{in revision}}
			{Global timescales of plant water response to soil moisture pulses}
			{Biogeosciences}
			{Feldman, AF, \textcl{DJ Short Gianotti}, AG Konings, P Gentine, \& D Entekhabi, ``Global 
			timescales of plant water response to soil moisture pulses,'' \emph{In revision} for 
			Biogeosciences.}
		\lpdentry
			{\emph{in prep}}
		...
		\lpdentry
			...
			dataset derived from AMSR-E/2,'' \emph{In revision} for Scientific Data.}
	...
	\subsection{Published Journal Articles}
		\lpdentry
			...
			{Water Resources Research}
			{Feldman, AF, J Chulakadabba, \textcl{DJ Short Gianotti}, \& D Entekhabi, ``Landscape-scale 
