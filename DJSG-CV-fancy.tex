...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		...
		\lpdentry
			...
			limitation across global ecosystems,'' \emph{In review} at Biogeosciences.}		
		\lpdentry
			{\emph{in review}}
		...
		\lpdentry
			...
			the Tipping-Point for Water and Energy Balance Coupling,'' \emph{In revision} at Water Resources Research.}		
		\lpdentry
			{\emph{accepted}}
			{Can Surface Soil
			...
			Transition Between Energy- and Water-limited Regimes?,'' \emph{Accepted} at Geophysical Research Letters.}		
		\lpdentry
			{\emph{in prep}}
	...
	\subsection{Published Journal Articles}
		...
		\lpdentry
			...
			dataset derived from AMSR-E/2,'' Scientific Data. \url{https://doi.org/10.1038/s41597-021-00925-8}}
		\lpdentry
			{2021a}
...
\dentry
		...
		{\emph{Drought Cascades in Past \& Future Climates} }	
	\dentry
		{2021-2022} 
		{Lily Zhang}
		{MIT SB in Earth, Atmospheric, \& Planetary Sciences}
		{\emph{Progression of Convective Available Potential Energy over Surface Drydowns} }	
	\dentry
		{2018-2019} 
