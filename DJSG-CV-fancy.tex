...
\newcommand{\lpdentry}[4]{\begin{entrylist}%
  ...
  \parbox[t]{7.5cm}{\raggedright\textbf{#2}}\hfill\parbox[t]{4cm}{\footnotesize\addfontfeature{Color=lightgray}\begin{flushright}#3\end{flushright}}\\
    ...
    {\begin{hangparas}{0.25in}{1}#4\vspace{\parsep}\end{hangparas}}%
  }\\\end{entrylist}}
...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			...
			in a warmer climate,'' \emph{Resubmitted} to Geophysical Research Letters.\\ 
		...
		\lpdentry
			...
			{New Phytologist}
			{Feldman, AF, \textcl{DJ Short Gianotti}, AG Konings, P Gentine, \& D Entekhabi, ``Global timescales of plant water response to 
		...
		\lpdentry
			...
			{Akbar, R, \textcl{DJ Short Gianotti}, GD Salvucci, \& D Entekhabi, ``Historical landscape drainage estimates derived from 
		...
		\lpdentry
			...
			subseasonal\hyp{}to\hyp{}seasonal precipitation statistics,'' Expected submission in Water Resources Research, February 2020.}
...
\subsection{Teaching Fellow:}
	\dentry
		{2015}
		{\emph{Introduction to Quantitative Environmental Modeling}} 
		{Boston University}
		{}
...
\subsection{Guest Lecturer:}
	\dentry
		{2016-2018}
		{\emph{Introduction to Hydrology and Water Resources}}
		{Massachusetts Institute of Technology}
		{}
	\dentry
		{2017}
		{\emph{Introduction to Hydrologic Modeling}}
		{Massachusetts Institute of Technology}
		{Massachusetts Institute of Technology}
		{}
...
\subsection{Thesis Committee Member:}
	\dentry
		...
		{Undergraduate Senior Thesis Title: \emph{Integration of Satellite and In-situ Data for the 
		Study of Vegetation Responses to Precipitation Pulses in the Southwestern United States } }
