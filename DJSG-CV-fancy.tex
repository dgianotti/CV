...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			...
			timescales of plant water response to soil moisture pulses,'' \emph{Submitted} to Biogeosciences.}
		\lpdentry
			{\emph{resubmitted}}
		...
		\lpdentry
			...
			{Feldman, AF, \textcl{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Land-atmosphere drivers of landscape-scale plant water content loss,'' \emph{Resubmitted} to Geophysical Research Letters.}
		\lpdentry
			{\emph{in prep.}}
