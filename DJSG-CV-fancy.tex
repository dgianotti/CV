...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			{\emph{in prep}}
			{Emergent coupling of terrestrial photosynthesis to turbulent heat partitioning}
			{Nature Geoscience}
			{\textcl{Short Gianotti, DJ}, KA McColl, AF Feldman, \& D Entekhabi, ``Emergent coupling of terrestrial 
			photosynthesis to turbulent heat partitioning,'' \emph{In preparation} for Nature Geoscience.}
		\lpdentry
			{\emph{in review}}
			{Observed water- and light-limitation across global ecosystems}
			{Remote Sensing of Environment}
			{Jonard, Francois, AF Feldman, \textcl{DJ Short Gianotti}, \& D Entekhabi, ``Observed water- and light-
			limitation across global ecosystems,'' \emph{In review} to Remote Sensing of Environment.}		
		\lpdentry
			{\emph{in revision}}
			{Observed landscape responsiveness to climate forcing}
			{Water Resources Research}
			{Feldman, AF, \textcl{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Observed landscape 
			responsiveness to climate forcing,'' \emph{In revision} to Water Resources Research.}
		\lpdentry
			{\emph{in review}}
			{Satellite-based assessment of meteorological and agricultural drought in Mainland Southeast Asia}
			{Journal of Selected Topics in Applied Earth Observations and Remote Sensing}
			{Li, Y, H Lu, D Entekhabi, \textcl{DJ Short Gianotti}, AF Feldman, K Yang, \& W Wang, ``Satellite-based 
			assessment of meteorological and agricultural drought in Mainland Southeast Asia,'' \emph{In review} to 
			Journal of Selected Topics in Applied Earth Observations and Remote Sensing.}			
		\lpdentry
			{\emph{in prep}}
			...
			\emph{In preparation} for Journal of Hydrometeorology.\\ 
	...
	\subsection{Published Journal Articles}
		\lpdentry
			...
			dataset derived from AMSR-E/2,'' \emph{In press} in Scientific Data.}
		\lpdentry
			{2021a}
			{Patterns of plant rehydration and growth following pulses of soil moisture availability}
			{Biogeosciences}
			{Feldman, AF, \textcl{DJ Short Gianotti}, AG Konings, P Gentine, \& D Entekhabi (2021), ``Patterns of plant rehydration and growth following pulses of soil moisture availability,'' Biogeosciences, 18, 831–847, \url{https://doi.org/10.5194/bg-18-831-2021}. \\
		...
		\lpdentry
			...
			{Water Resources Research}
			{Feldman, AF, J Chulakadabba, \textcl{DJ Short Gianotti}, \& D Entekhabi (2020), ``Landscape-scale 
		...
		\lpdentry
			...
			{Water Resources Research}
			{Akbar, R, \textcl{DJ Short Gianotti}, GD Salvucci, \& D Entekhabi (2020), ``Historical landscape 
			drainage estimates derived from satellite-era hydrological dynamics,'' 
