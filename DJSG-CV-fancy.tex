...
\section{publications \& talks}
	\subsection{Manuscripts in Progress}
		\lpdentry
			...
			{Nature Geoscience}
			{Feldman, AF, \textcl{DJ Short Gianotti}, J Dong, R Akbar, WT Crow, KA McColl, JB Nippert, NM Holbrook, FE Rockwell, RL Scott, RH Reichle, A Chatterjee, 
			J Joiner, B Poulter, D Entekhabi, ``Microwave satellites capture soil moisture dynamics deeper than a few centimeters and are relevant to plant water uptake,'' 
