...
\years{\emph{submitted}}Feldman, AF, \textbf{DJ Short Gianotti}, J Dong, R Akbar, WT Crow, KA McColl, JB Nippert, NM Holbrook, FE Rockwell, RL Scott, RH Reichle, A Chatterjee, J Joiner, B Poulter, D Entekhabi, ``Microwave satellites capture soil moisture dynamics deeper than a few centimeters and are relevant to plant water uptake,'' \emph{Submitted} to Nature Geoscience.\lbr 

\years{\emph{in review}}\textbf{Short Gianotti, DJ}, KA McColl, X Xu, AF Feldman, \& D Entekhabi, ``Ecosystem structural dynamics dominate physiology in coupling the terrestrial water and carbon cycles,'' \emph{In review} at PNAS.\lbr

\years{\emph{in revision}}Jonard, Francois, AF Feldman, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Observed water- and light-limitation across global ecosystems,'' \emph{In revision} at Biogeosciences.\lbr
