...
\years{\emph{submitted}}\textbf{Short Gianotti, DJ}, KA McColl, X Xu, AF Feldman, \& D Entekhabi, ``Ecosystem structural dynamics dominate physiology in coupling the terrestrial water and carbon cycles,'' \emph{Submitted} to Nature.\lbr

\years{\emph{accepted}}Feldman, AF, \textbf{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Observed landscape responsiveness to climate forcing,'' \emph{In press} in Water Resources Research.\lbr
...
\years{\emph{submitted}}Dong, J, R Akbar, \textbf{Short Gianotti, DJ}, AF Feldman, WT Crow, \& D Entekhabi, ``Can Surface Soil Moisture Information Identify the Landscape Evapotranspiration Transition Between Energy- and Water-limited Regimes?'' \emph{Submitted} to Geophysical Research Letters. \lbr
