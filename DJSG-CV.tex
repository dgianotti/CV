...
Hydroclimatology $\cdot$ Ecohydrology $\cdot$ Water, Carbon, and Energy Cycles \\
Land-Atmosphere Interactions $\cdot$ Stochastic and Statistical Modeling
...
\noindent
\years{2017e}Akbar, R, KA McColl, \textbf{DJ Short Gianotti}, E Haghighi, \& D Entekabi (2017), ``Estimation of the ecosystem-scale soil water losses from satellite observations of soil moisture,'' Geophysical Research Letters (\emph{in review}).\\
\years{2017d}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2017), ``Weather noise correctly dominates climate signals in global climate model precipitation,'' (\emph{in preparation}).\\ % Nature!
\years{2017c}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2017), ``A kernel\hyp{}auto\hyp{}regressive weather generator for improved subseasonal\hyp{}to\hyp{}seasonal precipitation statistics,''  (\emph{in preparation}).\\ % WRR!
\years{2017b} McColl, K, W Wang, B Peng, R Akbar, \textbf{D Short Gianotti}, M Pan, \& D Entekhabi (2017), ``Global characterization of surface soil moisture drydowns,'' Geophysical Research Letters (\emph{accepted}).\\
\years{2017a}Anderson, BT, JC Furtado, E Di Lorenzo, \textbf{DJ Short Gianotti} (2017), ``Tracking the Pacific Decadal Precession,'' Journal of Geophysical Research (\emph{in online pre-print}).\\
