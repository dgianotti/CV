...
\years{\emph{in prep}}Feldman, AF, \textbf{DJ Short Gianotti}, AG Konings, P Gentine, \& D Entekhabi, ``Global timescales of plant water response to soil moisture pulses,'' \emph{In preparation} for Biogeosciences, expected submission October, 2020. \lbr

\years{\emph{resubmitted}}Akbar, R, \textbf{DJ Short Gianotti}, GD Salvucci, \& D Entekhabi, ``Historical Landscape Drainage Estimates Derived from Satellite-Era Hydrological Dynamics,'' \emph{Resubmitted} to Water Resources Research.\lbr
...
\years{\emph{in revision}}Feldman, AF, \textbf{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Land-atmosphere drivers of landscape-scale plant water content loss,'' \emph{In revision} at Geophysical Research Letters.\lbr

\years{\emph{in prep.}}Panpan Y, H Lu, J Shi, T Zhao, K Yang, MH Cosh, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``A long term spatially and temporally consistent global daily soil moisture dataset derived from AMSR-E/2,'' \emph{In preparation} for Scientific Data, expected submission October, 2020.\lbr
