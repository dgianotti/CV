...
\noindent
\years{2015f}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2015), ``Precipitation climate signals in global climate models and observations,'' (\emph{in preparation}).\\ % Nature!
\years{2015e}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2015), ``A spatially-scalable precipitation weather generator model for climate nulls,''  (\emph{in preparation}).\\ % Environmetrics!
\years{2015d}Anderson, BT, \textbf{DJ Short Gianotti}, J Furtado, \& E Di Lorenzo (2015), ``A decadal precession of atmospheric pressures over the North Pacific,'' (\emph{in submission}).\\
\years{2015c}Anderson, BT, \textbf{DJ Short Gianotti}, \& GD Salvucci (2015), ``Detectability of historical trends in station-based precipitation characteristics over the continental United States,'' Journal of Geophysical Research (\emph{in press}).\\
