...
\years{\emph{submitted}}Feldman, AF, \textbf{DJ Short Gianotti}, AG Konings, P Gentine, \& D Entekhabi, ``Global timescales of plant water response to soil moisture pulses,'' \emph{Submitted} to Biogeosciences. \lbr

\years{\emph{resubmitted}}Feldman, AF, J Chulakadabba, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Ecosystem plant water content and carbon flux behavior following moisture pulses: from dryland to mesic environments,'' \emph{Resubmitted} to Water Resources Research. \lbr
			
\years{\emph{submitted}}\textbf{Short Gianotti, DJ}, GD Salvucci, \& BT Anderson, ``A kernel\hyp{}auto\hyp{}regressive weather generator for improved subseasonal\hyp{}to\hyp{}seasonal precipitation statistics,'' \emph{Submitted} to Water Resources Research. \\Preprint: \url{https://doi.org/10.1002/essoar.10503866.1}\lbr

\years{\emph{submitted}}Panpan Y, H Lu, J Shi, T Zhao, K Yang, MH Cosh, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``A long term spatially and temporally consistent global daily soil moisture dataset derived from AMSR-E/2,'' \emph{Submitted} to Scientific Data.\lbr
