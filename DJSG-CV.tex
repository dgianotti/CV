...
\years{\emph{submitted}}Feldman, AF, \textbf{DJ Short Gianotti}, J Dong, R Akbar, WT Crow, KA McColl, A Konings, JB Nippert, SJ Tumber-Davila, NM Holbrook, 
			FE Rockwell, RL Scott, RH Reichle, A Chatterjee, J Joiner, B Poulter, D Entekhabi, ``Satellites can capture soil moisture dynamics relevant to 
			plant water uptake,'' \emph{Submitted} to Water Resources Research. \\Preprint: \url{https://doi.org/10.1002/essoar.10511280.1} \lbr 

\years{\emph{resubmitted}}\textbf{Short Gianotti, DJ}, KA McColl, X Xu, AF Feldman, \& D Entekhabi, ``Ecosystem structural dynamics dominate physiology in coupling the terrestrial water and carbon cycles,'' \emph{Resubmitted} at PNAS.\lbr

\years{accepted}Jonard, F, AF Feldman, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Observed water- and light-limitation across global ecosystems,'' \emph{Accepted} at Biogeosciences.\lbr

\years{re-submitted}Dong, J, R Akbar, AF Feldman, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Land Surfaces at the Tipping-Point for Water and Energy Balance Coupling,'' \emph{Res-submitted} to Water Resources Research.\lbr
...
\years{\emph{submitted}}Zhang, LN, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Land Surface Influence on Convective Available Potential Energy (CAPE) Change During Interstorms,'' \emph{submitted} to Journal of Hydrometeorology.\lbr
			
\subsection*{Published journal articles}
\years{2022d}Feldman, AF, \textbf{DJ Short Gianotti}, J Dong, IF Trigo, GD Salvucci, \& D Entekhabi, ``Tropical surface temperature response to vegetation cover changes and the role of drylands,'' Global Change Biology.  \url{https://doi.org/10.1111/gcb.16455}\lbr

\years{2022c}Li, Y, H Lu, D Entekhabi, \textbf{DJ Short Gianotti}, K Yang, C Luo, AF Feldman, W Wang, \& R Jiang (2022), ``Satellite-based 
			assessment of meteorological and agricultural drought in Mainland Southeast Asia,'' 
			Journal of Selected Topics in Applied Earth Observations and Remote Sensing, 15, 6180-6189. \url{https://doi.org/10.1109/JSTARS.2022.3190438}\lbr
...
\par \years{2022-2023} \hangindent=1em Meriah Gannon (MIT MS in Climate, Environment, \& Sustainability)\\
\textbf{Thesis Title:} \emph{Drought Cascades in Past \& Future Climates} \lbr

\par \years{2021-2022} \hangindent=1em Lily Zhang (MIT SB in Earth, Atmospheric, \& Planetary Sciences)\\
\textbf{Thesis Title:} \emph{Progression of Convective Available Potential Energy over Surface Drydowns} \lbr 

\par \years{2018-2019} \hangindent=1em Apisada (Ju) Chulakadabba (MIT SB in Civil \& Environmental Engineering)\\
\textbf{Thesis Title:} \emph{Integration of Satellite and In-situ Data for the Study of Vegetation Responses to Precipitation Pulses in the Southwestern United States } \lbr
