...
\years{\emph{in revision}}Feldman, AF, J Chulakadabba, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Ecosystem plant water content and carbon flux behavior following moisture pulses: from dryland to mesic environments,'' \emph{In review} in Water Resources Research. \lbr
...
\years{2020b}F Jonard, S DeCanni\`ere, N Br\"uggemann, P Gentine, \textbf{DJ Short Gianotti}, G Lobet, DG Miralles, C Montzka, BR Pag\'an, U Rascher, \& H Vereecken ''Value of chlorophyll fluorescence for quantifying hydrological states and fluxes: Current status and challenges,'' \emph{In press} in Agricultural and Forest Meteorology. \lbr
