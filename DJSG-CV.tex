...
\years{\emph{in prep}}\textbf{Short Gianotti, DJ}, KA McColl, AF Feldman, \& D Entekhabi, ``Emergent coupling of terrestrial photosynthesis to turbulent heat partitioning,'' \emph{In preparation} for Nature Geoscience.\lbr

\years{\emph{in revision}}Feldman, AF, \textbf{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Observed landscape responsiveness to climate forcing,'' \emph{In revision} to Water Resources Research.\lbr
