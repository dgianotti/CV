...
\years{\emph{submitted}}Feldman, AF, \textbf{DJ Short Gianotti}, IF Trigo, GD Salvucci, \& D Entekhabi, ``Observed landscape responsiveness to climate forcing,'' \emph{Submitted} to Water Resources Research.\lbr

\years{\emph{submitted}}Jonard, Francois, AF Feldman, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Observed water- and light-limitation across global ecosystems,'' \emph{Submitted} to Remote Sensing of Environment.\lbr

\years{\emph{submitted}}Li, Y, H Lu, D Entekhabi, \textbf{DJ Short Gianotti}, AF Feldman, K Yang, \& W Wang, ``Satellite-based assessment of meteorological and agricultural drought in Mainland Southeast Asia,'' \emph{Submitted} to Journal of Selected Topics in Applied Earth Observations and Remote Sensing.\lbr
