...
\years{2018g}\textbf{Short Gianotti, DJ}, GD Salvucci, R Akbar, \& D Entekhabi (2018) ``Representative soil column water content and residence times from SMAP and GPM,'' Remote Sensing of Environment (\emph{in preparation}). \lbr

\years{2018f}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2018), ``A kernel\hyp{}auto\hyp{}regressive weather generator for improved subseasonal\hyp{}to\hyp{}seasonal precipitation statistics,''  Water Resources Research (\emph{in preparation}). \lbr

\years{2018e}Rigden, AJ, GD Salvucci, D Entekhabi, \& \textbf{DJ Short Gianotti} (2018) ``Divergent response of transpiration and soil evaporation to warming over the U.S.,'' Geophysical Research Letters (\emph{in submission}). \lbr \pagebreak


\years{2018d}Akbar, R, \textbf{DJ Short Gianotti}, KA McColl, E Haghighi, GD Salvucci, \& D Entekabi (2018), ``Estimation of ecosystem-scale soil water losses from satellite observations of soil moisture,'' Journal of Hydrometeorology (\emph{in review}). \lbr

\years{2018c}\textbf{Short Gianotti, DJ}, AJ Rigden, GD Salvucci, \& D Entekhabi (2018) ``Large-scale effects of water-limitation on the coupling of the water, energy, and carbon cycles,'' Global Change Biology (\emph{in review}). \lbr

\years{2018b}Akbar, R, \textbf{DJ Short Gianotti}, KA McColl, E Haghighi, GD Salvucci, \& D Entekhabi (2018) ``Hydrological Storage Length-scales Represented by Remote Sensing Estimates of Soil Moisture and Precipitation,'' Water Resources Research (\emph{in review}). \lbr

\years{2018a}Haighighi, E, \textbf{DJ Short Gianotti}, R Akbar, GD Salvucci, \& D Entekhabi (2018) ``Soil and atmospheric controls on the land surface energy balance: A generalized framework for distinguishing moisture- and energy-limited evaporation regimes,'' Water Resources Research (\emph{in press}). \lbr
