...
\section*{Education}
\noindent
\years{2011-Present}\textsc{PhD} in Geography and Environment, Boston University\\
...
\noindent
\years{2016c}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2015), ``Precipitation climate signals in global climate models and observations,'' (\emph{in preparation}).\\ % Nature!
\years{2016b}\textbf{Short Gianotti, DJ}, BT Anderson, \& GD Salvucci (2015), ``A spatially-scalable precipitation weather generator model for climate nulls,''  (\emph{in preparation}).\\ % Monthly Weather Review!
\years{2016a}Anderson, BT, \textbf{DJ Short Gianotti}, J Furtado, \& E Di Lorenzo (2015), ``A decadal precession of atmospheric pressures over the North Pacific,'' (\emph{in revision}).\\
