...
\years{\emph{submitted}}Feldman, AF, \textbf{DJ Short Gianotti}, J Dong, R Akbar, WT Crow, KA McColl, JB Nippert, NM Holbrook, FE Rockwell, RL Scott, RH Reichle, A Chatterjee, J Joiner, B Poulter, D Entekhabi, ``Microwave satellites capture soil moisture dynamics deeper than a few centimeters and are relevant to plant water uptake,'' \emph{Submitted} to Nature Geoscience. \\Preprint: \url{https://doi.org/10.1002/essoar.10511280.1} \lbr 

\years{\emph{in review}}\textbf{Short Gianotti, DJ}, KA McColl, X Xu, AF Feldman, \& D Entekhabi, ``Ecosystem structural dynamics dominate physiology in coupling the terrestrial water and carbon cycles,'' \emph{In revision} at PNAS.\lbr

\years{\emph{in revision}}Jonard, F, AF Feldman, \textbf{DJ Short Gianotti}, \& D Entekhabi, ``Observed water- and light-limitation across global ecosystems,'' \emph{In revision} at Biogeosciences.\lbr
...
\years{\emph{resubmitted}}Feldman, AF, \textbf{DJ Short Gianotti}, J Dong, IF Trigo, GD Salvucci, D Entekhabi, ``Tropical surface temperature response to vegetation cover changes and the role of drylands,'' \emph{Resubmitted} to Global Change Biology.\lbr
